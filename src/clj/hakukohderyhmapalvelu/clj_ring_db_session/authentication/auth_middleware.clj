(ns hakukohderyhmapalvelu.clj-ring-db-session.authentication.auth-middleware
  (:require
    ...
    [hakukohderyhmapalvelu.clj-ring-db-session.authentication.login :refer [logged-in?]]))
