...
(deftest hakukohderyhma-delete-service-test
  ...
  (deftest hakukohderyhma-simple-test
    (let [datetime-formatter (DateTimeFormatter/ofPattern "yyyy-MM-dd'T'HH:mm:ss")
          ...
          parse-time #(-> (LocalDateTime/parse % datetime-formatter)
                          (.atZone zone-id)
                          (.toOffsetDateTime))
          latest (parse-time "2024-05-01T16:00:00")
          second (parse-time "2024-05-01T12:00:00")
          oldest (parse-time "2024-05-01T11:00:00")
